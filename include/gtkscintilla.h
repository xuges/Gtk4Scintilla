...
GSCI_EXTERN void gtk_scintilla_set_style(GtkScintilla* self, const char* styleName);
GSCI_EXTERN const char* gtk_scintilla_get_language(GtkScintilla* self);
GSCI_EXTERN void gtk_scintilla_set_language(GtkScintilla* self, const char* language);
